...
function App() {
  return (
    <div className="App">
      ...
      <img src={bomba} alt="" />
      <br />
      <p className="body">Обваловка мешками с песком и кругляками</p>
      <br />
      <img src={bomba} alt="" />
      <br />
      <p className="body">Обваловка грунтом</p>
      <hr />
      <br />
      <h2>УКРЕПЛЕНИЕ ПОТОЛКА</h2>
      <p className="body">Необходимо на случай обрушения здания.</p>
      <br />
      <img src={bomba} alt="" />
      <br />
      <p className="body">
      ...
      <section>
        ...
        <ul>
          ...
          <li> Возьмите пару огнетушителей на случай возникновения пожара </li>
          <li>
        ...
        <br />
        <p className="bodyS">
          Авторы: <br /> Графический дизайн: <br /> Веб-сайт: <br /> Разработка:{" "}
          <br />
          Перевод: <br />
          <br />
          <br />
